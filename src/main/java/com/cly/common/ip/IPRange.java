...
/*
 * 修订记录:
 * qzhanbo@yiji.com 2015-11-02 14:08 创建
 *
 */
package com.cly.common.ip;
...
public class IPRange {
	 ...
	 * Constructor.
	 *
	 * @param range String representation of the IP address. The two following
	 * formats are supported :<br/>
	 * <li/>xxx.xxx.xxx.xxx/xxx.xxx.xxx.xxx <li/>xxx.xxx.xxx.xxx/xx <- extended
	 ...
	 *
	 * @return Return the string representation of the IP Address following the
	 * common format xxx.xxx.xxx.xxx/xx (IP address/extended network prefixs).
	 */
	...
	public boolean equals(Object o) {
		...
		if (extendedNetworkPrefix != ipRange.extendedNetworkPrefix)
			return false;
		if (ipAddress != null ? !ipAddress.equals(ipRange.ipAddress) : ipRange.ipAddress != null)
			return false;
		return !(ipSubnetMask != null ? !ipSubnetMask.equals(ipRange.ipSubnetMask) : ipRange.ipSubnetMask != null);
	...
	public int hashCode() {
		...
		result = 31 * result + (ipSubnetMask != null ? ipSubnetMask.hashCode() : 0);
		result = 31 * result + extendedNetworkPrefix;
		return result;
	}
}
