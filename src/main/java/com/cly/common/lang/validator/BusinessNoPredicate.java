...
/*
 * 修订记录:
 * linying@yiji.com 2016-05-05 09:49 创建
 *
 */
...
public class BusinessNoPredicate implements Predicate<String> {
    ...
    public static final Pattern VALID_BUSINESS_NO_REGEX = Pattern.compile("(^[\\dA-Za-z\u4E00-\u9FA5]+$)");
    ...
    public boolean apply(String input) {
        ...
        Matcher preSuffBlankMatcher = BlankInStringPreOrSuffPredicate.VALID_BLANKINSTRINGPREORSUFF_REGEX.matcher(input);
